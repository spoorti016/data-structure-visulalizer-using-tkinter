...
# importing time module which handles time related tasks
import time


# function to implement bubble sort by passing the following parameters:
    ...
    for i in range(n):
        for j in range(0, n - i - 1):
            ...
            if data[j] > data[j + 1]:
                ...
                time.sleep(timer)  # to add delay in execution of a program
